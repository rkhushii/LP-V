...
public:
    ...
    void sequentialBFS(int start) {
        ...
        cout << "\nSequential BFS starting from vertex " << start << ":\n";
        ...
        cout << "\n\nSequential BFS completed in " << duration.count() << " microseconds\n";
    }
    ...
    void sequentialDFS(int start) {
        ...
        cout << "\nSequential DFS starting from vertex " << start << ":\n";
        ...
        auto end_time = high_resolution_clock::now();
        auto duration = duration_cast<microseconds>(end_time - start_time);
        cout << "\n\nSequential DFS completed in " << duration.count() << " microseconds\n";
    }
